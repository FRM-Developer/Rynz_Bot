...
/******** OWNER NUMBER**********/
const ownerNumber = ["6283856085455@s.whatsapp.net","6282334297174@s.whatsapp.net"] 
/************************************/
...
const client = new WAConnection()
   ...
   console.log(color('[','white'),color('OM MAU NGAPAIN','red'),color(']','white'),color('QR MU SCAN AJA.SUBSCRIBE','white'),color('YOU','red'),color('TUBE','white'),color('RYNZ 01','yellow'))
})
          ...
          if (!isRegistered) return reply(ind.noregis())
           ...
           case 'demote':
			...
			if (isGroup && !isCmd && isSimi && budy != undefined) {
						...
						console.log(color('[WAH NGAPAIN OM]','yellow'), 'subsribe rynz 01', color(sender.split('@')[0]))
					}
					}
		} catch (e) {
			console.log('Error : %s', color(e, 'red'))
